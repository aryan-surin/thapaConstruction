    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <form @submit.prevent="handleSubmit" class="bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="flex space-x-4">
          ...
          <button
            type="submit"
            :disabled="submitting || !mainImageFile"
 ...
 * Create Project Page
 * 
 * Form to create a new project with image upload functionality.
 */
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (!mainImageFile.value) {
      errorMessage.value = 'Main image is required'
    ...
    let fullImageUrl = mainImageResult.url
    ...
    errorMessage.value = error.message || 'An error occurred while creating the project'
...
// SEO
useHead({
  title: 'Create Project - Admin - Thapa Construction',
  meta: [
